...
@Profile("test")
@Configuration
@PropertySource("classpath:/br/gov/sp/fatec/mapskills/report/config/datasource.properties")
public class DatabaseTestConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(final DataSource dataSource,
        ...
        emfb.setPersistenceUnitName("REPORTPersistenceUnit");
        emfb.setPersistenceXmlLocation("classpath*:/br/gov/sp/fatec/mapskills/report/config/persistence.xml");
        return emfb;
    }
